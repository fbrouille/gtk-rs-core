...
pub trait FileImpl: ObjectImpl + ObjectSubclass<Type: IsA<File>> {
    ...
    > {
        self.parent_append_to_future(flags, priority)
    }
    ...
    fn replace_future(
        ...
        Box<dyn std::future::Future<Output = Result<FileOutputStream, Error>> + 'static>,
    > {
        self.parent_replace_future(etag, make_backup, flags, priority)
    }
    ...
    fn delete_future(
        ...
        self.parent_delete_future(priority)
    }
    ...
    fn trash_future(
        ...
        self.parent_trash_future(priority)
    }
    ...
    fn make_directory_future(
        ...
        self.parent_make_directory_future(priority)
    }
    ...
    fn copy_future<F: FnMut(i64, i64) + Clone + 'static>(
        source: &File,
        destination: &File,
        flags: FileCopyFlags,
        ...
        Self::parent_copy_future(source, destination, flags, progress_callback, priority)
    }
    ...
    fn open_readwrite_future(
        &self,
        priority: glib::Priority,
    ) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<FileIOStream, Error>> + 'static>>
    {
        self.parent_open_readwrite_future(priority)
    }
    ...
    {
        self.parent_create_readwrite_future(flags, priority)
    }
    ...
    {
        self.parent_replace_readwrite_future(etag, make_backup, flags, priority)
    }
...
pub trait FileImplExt: FileImpl {
    ...
    fn parent_read_async<R: FnOnce(Result<FileInputStream, Error>) + 'static>(
        ...
        unsafe {
            ...
            unsafe extern "C" fn read_async_trampoline<
                T: FnOnce(Result<FileInputStream, Error>) + 'static,
            >(
                source_object_ptr: *mut glib::gobject_ffi::GObject,
                res: *mut ffi::GAsyncResult,
                user_data: glib::ffi::gpointer,
    ...
    fn parent_append_to_async<R: FnOnce(Result<FileOutputStream, Error>) + 'static>(
        &self,
        flags: FileCreateFlags,
        priority: glib::Priority,
        cancellable: Option<&Cancellable>,
        ...
        unsafe {
            ...
            let f = (*parent_iface)
                .append_to_async
                .expect("no parent interface implementation for \"append_to_async\"");
            let finish = (*parent_iface)
                .append_to_finish
                .expect("no parent interface \"append_to_finish\" implementation");
            ...
            f(
                ...
                priority.into_glib(),
                cancellable.to_glib_none().0,
                Some(append_to_async_trampoline::<R>),
                Box::into_raw(user_data) as *mut _,
            );
        }
    }

    fn parent_append_to_future(
        &self,
        flags: FileCreateFlags,
        priority: glib::Priority,
    ) -> std::pin::Pin<
    ...
    > {
        Box::pin(GioFuture::new(
            &self.ref_counted(),
            move |imp, cancellable, send| {
                imp.parent_append_to_async(flags, priority, Some(cancellable), move |res| {
                    send.resolve(res);
                });
            },
        ))
    ...
    fn parent_replace_async<R: FnOnce(Result<FileOutputStream, Error>) + 'static>(
        &self,
        etag: Option<&str>,
        make_backup: bool,
        flags: FileCreateFlags,
        ...
        unsafe {
            ...
            let f = (*parent_iface)
                .replace_async
                .expect("no parent interface implementation for \"replace_async\"");
            let finish = (*parent_iface)
                .replace_finish
                .expect("no parent interface \"replace_finish\" implementation");
            ...
            f(
                ...
                priority.into_glib(),
                cancellable.to_glib_none().0,
                Some(replace_async_trampoline::<R>),
                Box::into_raw(user_data) as *mut _,
            );
        }
    }

    fn parent_replace_future(
        &self,
        etag: Option<&str>,
        make_backup: bool,
        flags: FileCreateFlags,
    ...
    fn parent_delete_async<R: FnOnce(Result<(), Error>) + 'static>(
        &self,
        priority: glib::Priority,
        cancellable: Option<&Cancellable>,
        callback: R,
        ...
        unsafe {
            ...
            let f = (*parent_iface)
                .delete_file_async
                .expect("no parent interface implementation for \"delete_file_async\"");
            let finish = (*parent_iface)
                .delete_file_finish
                .expect("no parent interface \"delete_file_finish\" implementation");

            let user_data: Box<(glib::thread_guard::ThreadGuard<R>, _)> =
                Box::new((glib::thread_guard::ThreadGuard::new(callback), finish));

            unsafe extern "C" fn delete_async_trampoline<T: FnOnce(Result<(), Error>) + 'static>(
                source_object_ptr: *mut glib::gobject_ffi::GObject,
                res: *mut ffi::GAsyncResult,
                user_data: glib::ffi::gpointer,
            ) {
            ...
            f(
                ...
                priority.into_glib(),
                cancellable.to_glib_none().0,
                Some(delete_async_trampoline::<R>),
                Box::into_raw(user_data) as *mut _,
            );
        }
    }

    fn parent_delete_future(
        &self,
        priority: glib::Priority,
    ) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<(), Error>> + 'static>> {
        Box::pin(GioFuture::new(
            &self.ref_counted(),
            move |imp, cancellable, send| {
                imp.parent_delete_async(priority, Some(cancellable), move |res| {
                    send.resolve(res);
                });
            },
        ))
    ...
    fn parent_trash_async<R: FnOnce(Result<(), Error>) + 'static>(
        &self,
        priority: glib::Priority,
        cancellable: Option<&Cancellable>,
        callback: R,
        ...
        unsafe {
            ...
            let f = (*parent_iface)
                .trash_async
                .expect("no parent interface implementation for \"trash_async\"");
            let finish = (*parent_iface)
                .trash_finish
                .expect("no parent interface \"trash_finish\" implementation");

            let user_data: Box<(glib::thread_guard::ThreadGuard<R>, _)> =
                Box::new((glib::thread_guard::ThreadGuard::new(callback), finish));

            unsafe extern "C" fn trash_async_trampoline<T: FnOnce(Result<(), Error>) + 'static>(
                source_object_ptr: *mut glib::gobject_ffi::GObject,
                res: *mut ffi::GAsyncResult,
                user_data: glib::ffi::gpointer,
            ) {
            ...
            f(
                ...
                priority.into_glib(),
                cancellable.to_glib_none().0,
                Some(trash_async_trampoline::<R>),
                Box::into_raw(user_data) as *mut _,
            );
        }
    }

    fn parent_trash_future(
        &self,
        priority: glib::Priority,
    ) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<(), Error>> + 'static>> {
        Box::pin(GioFuture::new(
            &self.ref_counted(),
            move |imp, cancellable, send| {
                imp.parent_trash_async(priority, Some(cancellable), move |res| {
                    send.resolve(res);
                });
            },
        ))
    ...
    fn parent_make_directory_async<R: FnOnce(Result<(), Error>) + 'static>(
        &self,
        priority: glib::Priority,
        cancellable: Option<&Cancellable>,
        callback: R,
        ...
        unsafe {
            ...
            let f = (*parent_iface)
                ...
                .expect("no parent interface implementation for \"make_directory_async\"");
            let finish = (*parent_iface)
                .make_directory_finish
                .expect("no parent interface \"make_directory_finish\" implementation");
            ...
            f(
                ...
                priority.into_glib(),
                cancellable.to_glib_none().0,
                Some(make_directory_async_trampoline::<R>),
                Box::into_raw(user_data) as *mut _,
            );
        }
    }

    fn parent_make_directory_future(
        &self,
        priority: glib::Priority,
    ) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<(), Error>> + 'static>> {
        Box::pin(GioFuture::new(
            &self.ref_counted(),
            move |imp, cancellable, send| {
                imp.parent_make_directory_async(priority, Some(cancellable), move |res| {
                    send.resolve(res);
                });
            },
        ))
    ...
    fn parent_copy_async<F: FnMut(i64, i64) + 'static, R: FnOnce(Result<(), Error>) + 'static>(
        source: &File,
        destination: &File,
        flags: FileCopyFlags,
        progress_callback: Option<F>,
        ...
        unsafe {
            ...
            let f = (*parent_iface)
                .copy_async
                .expect("no parent interface implementation for \"copy_async\"");
            let finish = (*parent_iface)
                .copy_finish
                .expect("no parent interface implementation for \"copy_finish\"");
            ...
            f(
                ...
                Some(copy_async_trampoline::<F, R>),
                operation_data_ptr as *mut _,
            );
        }
    }

    fn parent_copy_future<F: FnMut(i64, i64) + Clone + 'static>(
        source: &File,
        destination: &File,
        flags: FileCopyFlags,
        progress_callback: Option<F>,
    ...
    fn parent_open_readwrite_async<R: FnOnce(Result<FileIOStream, Error>) + 'static>(
        &self,
        priority: glib::Priority,
        cancellable: Option<&Cancellable>,
        callback: R,
        ...
        unsafe {
            ...
            let f = (*parent_iface)
                ...
                .expect("no parent interface implementation for \"open_readwrite_async\"");
            let finish = (*parent_iface)
                .open_readwrite_finish
                .expect("no parent interface \"open_readwrite_finish\" implementation");

            let user_data: Box<(glib::thread_guard::ThreadGuard<R>, _)> =
                Box::new((glib::thread_guard::ThreadGuard::new(callback), finish));

            unsafe extern "C" fn open_readwrite_async_trampoline<
                T: FnOnce(Result<FileIOStream, Error>) + 'static,
            >(
                source_object_ptr: *mut glib::gobject_ffi::GObject,
                res: *mut ffi::GAsyncResult,
                user_data: glib::ffi::gpointer,
            ...
            f(
                ...
                priority.into_glib(),
                cancellable.to_glib_none().0,
                Some(open_readwrite_async_trampoline::<R>),
                Box::into_raw(user_data) as *mut _,
            );
        }
    }

    fn parent_open_readwrite_future(
        &self,
        priority: glib::Priority,
    ) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<FileIOStream, Error>> + 'static>>
    {
        Box::pin(GioFuture::new(
            &self.ref_counted(),
            move |imp, cancellable, send| {
                imp.parent_open_readwrite_async(priority, Some(cancellable), move |res| {
                    send.resolve(res);
                });
            },
        ))
    ...
    fn parent_create_readwrite_async<R: FnOnce(Result<FileIOStream, Error>) + 'static>(
        &self,
        flags: FileCreateFlags,
        priority: glib::Priority,
        cancellable: Option<&Cancellable>,
        ...
        unsafe {
            ...
            let f = (*parent_iface)
                ...
                .expect("no parent interface implementation for \"create_readwrite_async\"");
            let finish = (*parent_iface)
                .create_readwrite_finish
                .expect("no parent interface \"create_readwrite_finish\" implementation");
            ...
            f(
                ...
                priority.into_glib(),
                cancellable.to_glib_none().0,
                Some(create_readwrite_async_trampoline::<R>),
                Box::into_raw(user_data) as *mut _,
            );
        }
    }

    fn parent_create_readwrite_future(
        &self,
        flags: FileCreateFlags,
        priority: glib::Priority,
    ) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<FileIOStream, Error>> + 'static>>
    {
        Box::pin(GioFuture::new(
            &self.ref_counted(),
            move |imp, cancellable, send| {
                imp.parent_create_readwrite_async(flags, priority, Some(cancellable), move |res| {
                    send.resolve(res);
                });
            },
        ))
    ...
    fn parent_replace_readwrite_async<R: FnOnce(Result<FileIOStream, Error>) + 'static>(
        &self,
        etag: Option<&str>,
        make_backup: bool,
        flags: FileCreateFlags,
        ...
        unsafe {
            ...
            let f = (*parent_iface)
                ...
                .expect("no parent interface implementation for \"replace_readwrite_async\"");
            let finish = (*parent_iface)
                .replace_readwrite_finish
                .expect("no parent interface \"replace_readwrite_finish\" implementation");
            ...
            f(
                ...
                priority.into_glib(),
                cancellable.to_glib_none().0,
                Some(replace_readwrite_async_trampoline::<R>),
                Box::into_raw(user_data) as *mut _,
            );
        }
    }

    fn parent_replace_readwrite_future(
        &self,
        etag: Option<&str>,
        make_backup: bool,
        flags: FileCreateFlags,
    ...
    ) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<FileIOStream, Error>> + 'static>>
    {
        ...
        Box::pin(GioFuture::new(
            &self.ref_counted(),
            move |imp, cancellable, send| {
                imp.parent_replace_readwrite_async(
                    etag.as_deref(),
                    make_backup,
                    flags,
                    priority,
...
unsafe extern "C" fn file_read_async<T: FileImpl>(
    ...
    unsafe {
        ...
        // Closure that will invoke the C callback when the LocalTask completes
        let closure = move |task: LocalTask<FileInputStream>,
                            source_object: Option<&glib::Object>| {
            let result: *mut ffi::GAsyncResult = task.upcast_ref::<AsyncResult>().to_glib_none().0;
            let source_object: *mut glib::gobject_ffi::GObject = source_object.to_glib_none().0;
            callback.unwrap()(source_object, result, user_data)
        ...
        glib::MainContext::ref_thread_default().spawn_local(async move {
            // Call the trait method's future version
            let res = imp.read_future(from_glib(io_priority)).await;
...
unsafe extern "C" fn file_read_finish(
    ...
    unsafe {
        let res: AsyncResult = from_glib_none(res_ptr);
        let t = res.downcast::<LocalTask<FileInputStream>>().unwrap();
        let ret = t.propagate();
        match ret {
            Ok(val) => val.to_glib_full(),
            Err(e) => {
...
unsafe extern "C" fn file_append_to_async<T: FileImpl>(
    ...
    unsafe {
        ...
        glib::MainContext::ref_thread_default().spawn_local(async move {
            // Call the trait method's future version
            let res = imp
                .append_to_future(from_glib(flags), from_glib(io_priority))
                .await;
...
unsafe extern "C" fn file_delete_file_async<T: FileImpl>(
    file: *mut ffi::GFile,
    io_priority: i32,
    cancellable: *mut ffi::GCancellable,
    callback: ffi::GAsyncReadyCallback,
    ...
    unsafe {
        ...
        glib::MainContext::ref_thread_default().spawn_local(async move {
            // Call the trait method's future version
            let res = imp.delete_future(from_glib(io_priority)).await;
...
unsafe extern "C" fn file_delete_file_finish(
    _file: *mut ffi::GFile,
    res_ptr: *mut ffi::GAsyncResult,
    error_ptr: *mut *mut glib::ffi::GError,
) -> glib::ffi::gboolean {
...
unsafe extern "C" fn file_trash_async<T: FileImpl>(
    file: *mut ffi::GFile,
    io_priority: i32,
    cancellable: *mut ffi::GCancellable,
    callback: ffi::GAsyncReadyCallback,
    ...
    unsafe {
        ...
        glib::MainContext::ref_thread_default().spawn_local(async move {
            // Call the trait method's future version
            let res = imp.trash_future(from_glib(io_priority)).await;
...
unsafe extern "C" fn file_trash_finish(
    _file: *mut ffi::GFile,
    res_ptr: *mut ffi::GAsyncResult,
    error_ptr: *mut *mut glib::ffi::GError,
) -> glib::ffi::gboolean {
...
unsafe extern "C" fn file_make_directory_async<T: FileImpl>(
    file: *mut ffi::GFile,
    io_priority: i32,
    cancellable: *mut ffi::GCancellable,
    callback: ffi::GAsyncReadyCallback,
    ...
    unsafe {
        ...
        glib::MainContext::ref_thread_default().spawn_local(async move {
            // Call the trait method's future version
            let res = imp.make_directory_future(from_glib(io_priority)).await;
...
unsafe extern "C" fn file_make_directory_finish(
    _file: *mut ffi::GFile,
    res_ptr: *mut ffi::GAsyncResult,
    error_ptr: *mut *mut glib::ffi::GError,
) -> glib::ffi::gboolean {
...
unsafe extern "C" fn file_copy_async<T: FileImpl>(
    source: *mut ffi::GFile,
    destination: *mut ffi::GFile,
    flags: ffi::GFileCopyFlags,
    io_priority: i32,
...
unsafe extern "C" fn file_copy_finish(
...
unsafe extern "C" fn file_open_readwrite_async<T: FileImpl>(
    file: *mut ffi::GFile,
    io_priority: i32,
    cancellable: *mut ffi::GCancellable,
    callback: ffi::GAsyncReadyCallback,
    ...
    unsafe {
        ...
        // Closure that will invoke the C callback when the LocalTask completes
        let closure = move |task: LocalTask<FileIOStream>, source_object: Option<&glib::Object>| {
            let result: *mut ffi::GAsyncResult = task.upcast_ref::<AsyncResult>().to_glib_none().0;
            let source_object: *mut glib::gobject_ffi::GObject = source_object.to_glib_none().0;
            callback.unwrap()(source_object, result, user_data)
        };
        ...
        glib::MainContext::ref_thread_default().spawn_local(async move {
            // Call the trait method's future version
            let res = imp.open_readwrite_future(from_glib(io_priority)).await;
...
unsafe extern "C" fn file_open_readwrite_finish(
    _file: *mut ffi::GFile,
    res_ptr: *mut ffi::GAsyncResult,
    error_ptr: *mut *mut glib::ffi::GError,
) -> *mut ffi::GFileIOStream {
    unsafe {
        let res: AsyncResult = from_glib_none(res_ptr);
        let t = res.downcast::<LocalTask<FileIOStream>>().unwrap();
        let ret = t.propagate();
        match ret {
            Ok(val) => val.to_glib_full(),
            Err(e) => {
...
unsafe extern "C" fn file_create_readwrite_async<T: FileImpl>(
    file: *mut ffi::GFile,
    flags: ffi::GFileCreateFlags,
    io_priority: i32,
    cancellable: *mut ffi::GCancellable,
    ...
    unsafe {
        ...
        glib::MainContext::ref_thread_default().spawn_local(async move {
            let res = imp
                .create_readwrite_future(from_glib(flags), from_glib(io_priority))
                .await;
...
unsafe extern "C" fn file_create_readwrite_finish(
    _file: *mut ffi::GFile,
    res_ptr: *mut ffi::GAsyncResult,
    error_ptr: *mut *mut glib::ffi::GError,
) -> *mut ffi::GFileIOStream {
...
unsafe extern "C" fn file_replace_readwrite_async<T: FileImpl>(
    file: *mut ffi::GFile,
    etag: *const c_char,
    make_backup: glib::ffi::gboolean,
    flags: ffi::GFileCreateFlags,
...
unsafe extern "C" fn file_replace_readwrite_finish(
    _file: *mut ffi::GFile,
    res_ptr: *mut ffi::GAsyncResult,
    error_ptr: *mut *mut glib::ffi::GError,
) -> *mut ffi::GFileIOStream {
