    ...
    impl FileImpl for MyFile {
        ...
        > {
            Box::pin(GioFuture::new(
                &self.ref_counted(),
                move |self_, cancellable, send| {
                    let res = self_.read_fn(Some(cancellable));
                    send.resolve(res);
                },
            ))
        }
        ...
        > {
            Box::pin(GioFuture::new(
                &self.ref_counted(),
                move |self_, cancellable, send| {
                    let res = self_.create(flags, Some(cancellable));
                    send.resolve(res);
                },
            ))
        }
        ...
        > {
            ...
            Box::pin(GioFuture::new(
                &self.ref_counted(),
                move |self_, cancellable, send| {
                    let res = self_.replace(etag.as_deref(), make_backup, flags, Some(cancellable));
                    send.resolve(res);
                },
            ))
        }
        ...
        ) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<(), Error>> + 'static>>
        {
            Box::pin(GioFuture::new(
                &self.ref_counted(),
                move |self_, cancellable, send| {
                    let res = self_.make_directory(Some(cancellable));
                    send.resolve(res);
                },
            ))
        }
        ...
        > {
            Box::pin(GioFuture::new(
                &self.ref_counted(),
                move |self_, cancellable, send| {
                    let res = self_.create_readwrite(flags, Some(cancellable));
                    send.resolve(res);
                },
            ))
        }
        ...
        > {
            ...
            Box::pin(GioFuture::new(
                &self.ref_counted(),
                move |self_, cancellable, send| {
                    let res = self_.replace_readwrite(
                        etag.as_deref(),
                        make_backup,
                        flags,
                        Some(cancellable),
...
fn file_read_future() {
    // run test in a main context dedicated and configured as the thread default one
    let _ = glib::MainContext::new().with_thread_default(|| {
        // invoke `MyCustomFile` implementation of `crate::ffi::GFileIface::read_async/finish`
        let my_custom_file = MyCustomFile::new("/my_file");
        let res = glib::MainContext::ref_thread_default()
            .block_on(my_custom_file.read_future(glib::Priority::DEFAULT));
        assert!(
            res.is_err(),
            "unexpected file input stream {:?}",
            res.ok().unwrap()
        ...
        // invoke `MyFile` implementation of `crate::ffi::GFileIface::read_async/finish`
        let my_file = MyFile::new("/my_file");
        let res = glib::MainContext::ref_thread_default()
            .block_on(my_file.read_future(glib::Priority::DEFAULT));
        assert!(
            res.is_err(),
            "unexpected file input stream {:?}",
            res.ok().unwrap()
...
#[test]
fn file_create_future() {
    // run test in a main context dedicated and configured as the thread default one
    let _ = glib::MainContext::new().with_thread_default(|| {
        // invoke `MyCustomFile` implementation of `crate::ffi::GFileIface::create_async/finish`
        let my_custom_file = MyCustomFile::new("/my_file");
        let res = glib::MainContext::ref_thread_default()
            .block_on(my_custom_file.create_future(FileCreateFlags::NONE, glib::Priority::DEFAULT));
        assert!(
            res.is_err(),
            "unexpected file output stream {:?}",
            res.ok().unwrap()
        ...
        // invoke `MyFile` implementation of `crate::ffi::GFileIface::create_async/finish`
        let my_file = MyFile::new("/my_file");
        let res = glib::MainContext::ref_thread_default()
            .block_on(my_file.create_future(FileCreateFlags::NONE, glib::Priority::DEFAULT));
        assert!(
            res.is_err(),
            "unexpected file output stream {:?}",
            res.ok().unwrap()
...
#[test]
fn file_replace_future() {
    // run test in a main context dedicated and configured as the thread default one
    let _ = glib::MainContext::new().with_thread_default(|| {
        // invoke `MyCustomFile` implementation of `crate::ffi::GFileIface::replace_async/finish`
        let my_custom_file = MyCustomFile::new("/my_file");
        let res = glib::MainContext::ref_thread_default().block_on(my_custom_file.replace_future(
            None,
            false,
        ...
        // invoke `MyFile` implementation of `crate::ffi::GFileIface::replace_async/finish`
        let my_file = MyFile::new("/my_file");
        let res = glib::MainContext::ref_thread_default().block_on(my_file.replace_future(
            None,
            false,
            FileCreateFlags::NONE,
            glib::Priority::DEFAULT,
...
#[test]
fn file_make_directory_future() {
    // run test in a main context dedicated and configured as the thread default one
    let _ = glib::MainContext::new().with_thread_default(|| {
        // invoke `MyCustomFile` implementation of `crate::ffi::GFileIface::make_directory_async/finish`
        let my_custom_dir = MyCustomFile::new("/my_directory");
        let res = glib::MainContext::ref_thread_default()
            .block_on(my_custom_dir.make_directory_future(glib::Priority::DEFAULT));
        assert!(res.is_ok(), "{}", res.unwrap_err());

        // invoke `MyFile` implementation of `crate::ffi::GFileIface::make_directory_async/finish`
        let my_dir = MyFile::new("/my_directory");
        let res = glib::MainContext::ref_thread_default()
            .block_on(my_dir.make_directory_future(glib::Priority::DEFAULT));
        assert!(res.is_ok(), "{}", res.unwrap_err());
...
fn file_copy_future() {
    // run test in a main context dedicated and configured as the thread default one
    let _ = glib::MainContext::new().with_thread_default(|| {
        // invoke `MyCustomFile` implementation of `crate::ffi::GFileIface::copy_async/finish`
        let my_custom_source_file = MyCustomFile::new("/my_file1");
        let my_custom_destination_file = MyCustomFile::new("/my_file2");
        let (future, _) = my_custom_source_file.copy_future(
            &my_custom_destination_file,
            FileCopyFlags::NONE,
            glib::Priority::DEFAULT,
        );
        ...
        // invoke `MyFile` implementation of `crate::ffi::GFileIface::copy_async/finish`
        let my_source_file = MyFile::new("/my_file1");
        let my_destination_file = MyFile::new("/my_file2");
        let (future, _) = my_source_file.copy_future(
            &my_destination_file,
            FileCopyFlags::NONE,
            glib::Priority::DEFAULT,
        );
        ...
        let my_custom_destination_directory =
            MyCustomFile::with_type_state("/my_dir2", FileType::Directory, MyFileState::Exist);
        let (future, _) = my_custom_source_directory.copy_future(
            &my_custom_destination_directory,
            FileCopyFlags::OVERWRITE,
            glib::Priority::DEFAULT,
        );
        ...
        let my_destination_directory =
            MyFile::with_type_state("/my_dir2", FileType::Directory, MyFileState::Exist);
        let (future, _) = my_source_directory.copy_future(
            &my_destination_directory,
            FileCopyFlags::OVERWRITE,
            glib::Priority::DEFAULT,
        );
        ...
        let (future, mut progress_stream) = my_custom_source_file.copy_future(
            &my_custom_destination_file,
            FileCopyFlags::NONE,
            glib::Priority::DEFAULT,
        );
        ...
        let my_destination_file =
            MyFile::with_type_state("/my_file2", FileType::Regular, MyFileState::DoesNotExist);
        let (expected, mut progress_stream) = my_source_file.copy_future(
            &my_destination_file,
            FileCopyFlags::NONE,
            glib::Priority::DEFAULT,
        );
...
#[test]
fn file_create_readwrite_future() {
    // run test in a main context dedicated and configured as the thread default one
    let _ = glib::MainContext::new().with_thread_default(|| {
        // invoke `MyCustomFile` implementation of `crate::ffi::GFileIface::create_readwrite_async/finish`
        let my_custom_file = MyCustomFile::new("/my_file");
        let res = glib::MainContext::ref_thread_default().block_on(
            my_custom_file.create_readwrite_future(FileCreateFlags::NONE, glib::Priority::DEFAULT),
        );
        assert!(
            res.is_err(),
            "unexpected file create read write success {:?}",
        ...
        // invoke `MyFile` implementation of `crate::ffi::GFileIface::create_readwrite_async/finish`
        let my_file = MyFile::new("/my_file");
        let res = glib::MainContext::ref_thread_default().block_on(
            my_file.create_readwrite_future(FileCreateFlags::NONE, glib::Priority::DEFAULT),
        );
        assert!(
            res.is_err(),
            "unexpected file create read write success {:?}",
...
#[test]
fn file_replace_readwrite_future() {
    // run test in a main context dedicated and configured as the thread default one
    let _ = glib::MainContext::new().with_thread_default(|| {
        // invoke `MyCustomFile` implementation of `crate::ffi::GFileIface::replace_readwrite_async/finish`
        let my_custom_file = MyCustomFile::new("/my_file");
        let res = glib::MainContext::ref_thread_default().block_on(
            my_custom_file.replace_readwrite_future(
                None,
                false,
                FileCreateFlags::NONE,
                glib::Priority::DEFAULT,
        ...
        // invoke `MyFile` implementation of `crate::ffi::GFileIface::replace_readwrite_async/finish`
        let my_file = MyFile::new("/my_file");
        let res =
            glib::MainContext::ref_thread_default().block_on(my_file.replace_readwrite_future(
                None,
                false,
                FileCreateFlags::NONE,
                glib::Priority::DEFAULT,
