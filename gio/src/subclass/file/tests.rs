...
fn file_enumerate_children_future() {
    ...
    let _ = glib::MainContext::new().with_thread_default(|| {
        // invoke `MyCustomFileEnumerator` implementation of `crate::ffi::GFileIface::enumerate_children_future` asynchronously
        let my_custom_file =
            MyCustomFile::with_type_state("/my_file", FileType::Regular, MyFileState::Exist);
        ...
        // invoke `MyFileEnumerator` implementation of `crate::ffi::GFileIface::enumerate_children_future` asynchronously
        let my_file = MyFile::with_type_state("/my_file", FileType::Regular, MyFileState::Exist);
        let res =
...
fn file_query_info_future() {
    // run test in a main context dedicated and configured as the thread default one
    let _ = glib::MainContext::new().with_thread_default(|| {
        // invoke `MyCustomFile` implementation of `crate::ffi::GFileIface::query_info_future` asynchronously
        let my_custom_file =
            MyCustomFile::with_xattr("/my_file", vec!["xattr::key1=value1", "xattr::key2=value2"]);
        let res =
        ...
        // invoke `MyFile` implementation of `crate::ffi::GFileIface::query_info_future` asynchronously
        let my_file =
...
fn file_query_filesystem_info_future() {
    // run test in a main context dedicated and configured as the thread default one
    let _ = glib::MainContext::new().with_thread_default(|| {
        // invoke `MyCustomFile` implementation of `crate::ffi::GFileIface::query_filesystem_info_future` asynchronously
        let my_custom_file =
            MyCustomFile::with_xattr("/my_file", vec!["xattr::key1=value1", "xattr::key2=value2"]);
        ...
        // invoke `MyFile` implementation of `crate::ffi::GFileIface::query_filesystem_info_future` asynchronously
        let my_file =
            MyFile::with_xattr("/my_file", vec!["xattr::key1=value1", "xattr::key2=value2"]);
        let res = glib::MainContext::ref_thread_default()
